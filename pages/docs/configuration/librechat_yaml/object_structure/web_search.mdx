...
<OptionTable
  options={[
    [
      'searchProvider',
      'String',
      'Specifies which search provider to use.',
...
<OptionTable
  options={[
    [
      'scraperType',
      'String',
      'Specifies which scraper service to use.',
...
<OptionTable options={[['formats', 'Array of Strings', 'Formats to include in the output.', '']]} />

#### includeTags

<OptionTable
  options={[['includeTags', 'Array of Strings', 'Tags to include in the output.', '']]}
/>

#### excludeTags

<OptionTable
  options={[['excludeTags', 'Array of Strings', 'Tags to exclude from the output.', '']]}
/>
...
<OptionTable
  options={[
    [
      'maxAge',
      'Number',
      'Returns a cached version of the page if it is younger than this age in milliseconds. If a cached version of the page is older than this value, the page will be scraped.',
      '',
    ],
  ]}
/>
...
<OptionTable options={[['mobile', 'Boolean', 'Emulate scraping from a mobile device.', '']]} />
...
<OptionTable
  options={[['blockAds', 'Boolean', 'Enables ad-blocking and cookie popup blocking.', '']]}
/>
...
<OptionTable
  options={[['parsePDF', 'Boolean', 'Controls how PDF files are processed during scraping.', '']]}
/>
...
<OptionTable
  options={[
    [
      'storeInCache',
      'Boolean',
      'If true, the page will be stored in the Firecrawl index and cache. Setting this to false is useful if your scraping activity may have data protection concerns. Using some parameters associated with sensitive scraping (headers) will force this parameter to be false.',
      '',
    ],
  ]}
/>
...
<OptionTable
  options={[
    [
      'zeroDataRetention',
      'Boolean',
      'If true, this will enable zero data retention for this scrape (requires prior setup on Firecrawl).',
      '',
    ],
  ]}
/>
...
<OptionTable
  options={[['location', 'Object', 'Geographic location and language settings for scraping.', '']]}
/>
...
<OptionTable
  options={[
    [
      'changeTrackingOptions',
      'Object',
      'Configuration for tracking changes in scraped content.',
      '',
    ],
  ]}
/>
...
<OptionTable
  options={[
    [
      'rerankerType',
      'String',
      'Specifies which reranker service to use.',
      'Options: "jina", "cohere"',
    ],
  ]}
/>
...
<OptionTable
  options={[
    [
      'safeSearch',
      'Number',
      'Safe search filtering level. 0 = OFF (no filtering), 1 = MODERATE (default), 2 = STRICT (maximum filtering).',
      'Default: 1 (MODERATE)',
    ],
  ]}
/>
