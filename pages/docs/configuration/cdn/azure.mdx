...
<div className="mt-8 mb-16">
  ...
  <ul className="space-y-2">
    ...
    <li>
      <a href="#local-development-with-azurite">Local Development with Azurite</a>
    </li>
  </ul>
</div>
...
<Callout type="info" title="Note">
  The default Azurite account key is a fixed value used for development purposes only. Never use
  this key in production environments. Always ensure that your connection string remains secure and
